...
\ctufitabstractCZE{
    Tato práce navrhuje genetický algoritmus s novou reprezentací chromozomu a novou implementací křížení pro umístění obdélníkových obrazů na dvoudimenzionální mřížku.
...
\ctufitabstractENG{
    The thesis proposes a genetic algorithm with a novel chromosome representation and novel crossover implementation for placing rectangular paintings on a two-dimensional grid.
