...
First, let us describe what a slicing tree is. \todo{pridat poznamku, ze slicing tree muze reprezentovat jakykoliv floorplan}
...
\afterpage{%
    ...
    \begin{landscape}% Landscape page
        \begin{figure}
            ...
            {Example of a slicing layout construction from a resolved slicing tree. There are three paintings, $1,2,3$ together with their areas $a_1, a_2, a_3$.
