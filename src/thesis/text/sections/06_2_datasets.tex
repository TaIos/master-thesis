...
\begin{table}[]
    \begin{tabular}{|c|c|c|c|c|}
        ...
        cluster\_3\_10 & 30 & 42 x 34 & clustering & \begin{tabular}[c]{@{}c@{}}
                                                         3 clusters,\\ 10 paintings each
        \end{tabular} \\ \hline
        cluster\_4\_20 & 80 & 66 x 54 & clustering & \begin{tabular}[c]{@{}c@{}}
                                                         4 clusters,\\ 10 paintings each
        \end{tabular} \\ \hline
...
%    \hspace{1pt}
%            \subfloat[]{\includegraphics[width=0.7\textwidth]{heatmap_random_20}\label{subfig:heatmap-random-20}}
%    \hspace{1pt}
%            \subfloat{\includegraphics[width=0.7\textwidth]{heatmap_packing_10}\label{subfig:heatmap-packing-10}}
%    \hspace{1pt}
%            \subfloat[]{\includegraphics[width=0.7\textwidth]{heatmap_packing_20}\label{subfig:heatmap-packing-20}}
            \subfloat{\includegraphics[width=0.8\textwidth]{heatmap_cluster_3_10}\label{subfig:heatmap-cluster-3-10}}
