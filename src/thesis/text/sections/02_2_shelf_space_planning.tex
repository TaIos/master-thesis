...
Decoding of an individual then takes place, which serves as an input to the BL-F (Bottom Left Fill) pack heuristic to fill up the shelves and calculate fitness.
