...
\afterpage{%
    ...
    \begin{landscape}% Landscape page
        \begin{figure}
            ...
            For population scaling factor $k$ and instance of size $N$, i.e. the number of paintings, population size is $k \times N$.}
            \label{fig:pop-size}%
        \end{figure}
    \end{landscape}
...
\afterpage{%
    ...
    \begin{landscape}% Landscape page
        \begin{figure}
            ...
            Diagonal multiple $k$ determines overlapping penalization constant as $k \times \sqrt{w^2 + h^2}$, where $w$, $h$ are dimension of the layout.}
...
%        \subfloat{\includegraphics[width=0.8\textwidth]{visualization_random20_ga}\label{subfig:random20-ga}}
