...
It penalizes individuals that represent solution with paintings that overlap.

Performance results for two random instances are in figure~\ref{fig:hyperparameters-overlapping-penalization-constant}.
