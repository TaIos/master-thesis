...
Both the datasets and Python code are in the attached medium.
...
The concrete value for the eval function is in the appendix listing~\ref{lst:biased-sparse-cluster-eval-function}.
