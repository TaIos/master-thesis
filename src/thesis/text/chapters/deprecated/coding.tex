...
\begin{figure}[htp]
    \includegraphics[width=1.0\textwidth, center]{chromosome}\caption{
...
\begin{figure}[htp]
    \includegraphics[width=1.1\textwidth, left]{pupulation_schema}\caption{Initial population generation strategy and transition from generation $k$ to $k+1$.}
