...
\navesti{Shelf-space planning} has two main parts – dividing a shelf into rectangles and assigning a product to them.
...
\navesti{Sheet metal cutting} evaluates two aspects – compactness of the layout and distance taken by the path cutting tool to cut all placed parts.
